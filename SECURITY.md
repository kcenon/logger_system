...
If you discover a security vulnerability in Logger System, please report it
responsibly through one of the following channels:

- **Email**: [kcenon@naver.com](mailto:kcenon@naver.com)
- **GitHub Security Advisories**: [Report here](https://github.com/kcenon/logger_system/security/advisories/new)
...
When using Logger System in your projects:

- Always use the latest stable release
- Monitor the [GitHub Security Advisories](https://github.com/kcenon/logger_system/security/advisories) page for updates
